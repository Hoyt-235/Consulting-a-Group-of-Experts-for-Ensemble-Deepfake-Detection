...
print("Registered detectors:", DETECTOR.data.keys())
...
parser.add_argument('--detector_path', type=str,
                    default='/workspace/src/training/config/detector/uia_vit.yaml',
...
#torch.cuda.set_device(args.local_rank)  UNCOMMENT IF CUDA IS AVAILABLE
...
def main():
    ...
    with open('/workspace/src/training/config/train_config.yaml', 'r') as f:
